-- Riyaaz-specific compositional prompt modules
-- Designed for Deepgram + Claude Haiku — short, focused modules that preserve cultural warmth

-- ============================================
-- 1. PERSONA: who the agent is, how they sound
-- ============================================
...
-- ============================================
-- 2. VERTICAL: domain knowledge for Indian classical music shop
-- ============================================
INSERT INTO public.prompt_modules (name, version, vertical_slug, content, params_schema, status)
VALUES (
    'vertical',
...
-- ============================================
-- 3. BUSINESS: per-shop facts (parameterized for Riyaaz)
-- ============================================
INSERT INTO public.prompt_modules (name, version, vertical_slug, content, params_schema, status)
VALUES (
    'business',
...
$BUSINESS$,
    '{"type":"object","properties":{"shop_name":{"type":"string"},"shop_phone":{"type":"string"},"shop_location":{"type":"string"},"business_hours":{"type":"string"}}}',
    'live'
)
ON CONFLICT (name, version, vertical_slug) DO NOTHING;

-- ============================================
-- 4. STATE: discovery — finding out what the caller wants
-- ============================================
INSERT INTO public.prompt_modules (name, version, vertical_slug, content, params_schema, status)
VALUES (
    'state_discovery',
...
-- ============================================
-- 5. STATE: scheduling — collecting request details (callback-based)
-- ============================================
INSERT INTO public.prompt_modules (name, version, vertical_slug, content, params_schema, status)
VALUES (
    'state_scheduling',
...
-- ============================================
-- 6. STATE: closing — ending the call gracefully
-- ============================================
INSERT INTO public.prompt_modules (name, version, vertical_slug, content, params_schema, status)
VALUES (
    'state_closing',
...
-- ============================================
-- 8. TOOLS: function definitions as prompts
-- ============================================
INSERT INTO public.prompt_modules (name, version, vertical_slug, content, params_schema, status)
VALUES (
    'tools',
...
BEGIN
    ...
    -- Insert fresh bindings
    INSERT INTO public.shop_prompt_bindings (shop_id, module_name, module_version, vertical_slug)
    VALUES
        (v_shop_id, 'persona', 1, 'music_lessons'),
        (v_shop_id, 'vertical', 1, 'music_lessons'),
        (v_shop_id, 'business', 1, 'music_lessons'),
        (v_shop_id, 'state_discovery', 1, 'music_lessons'),
        (v_shop_id, 'state_scheduling', 1, 'music_lessons'),
        (v_shop_id, 'state_closing', 1, 'music_lessons'),
        (v_shop_id, 'runtime', 1, 'music_lessons'),
        (v_shop_id, 'tools', 1, 'music_lessons'),
        (v_shop_id, 'guardrails', 1, 'music_lessons'),
        (v_shop_id, 'few_shot', 1, 'music_lessons');
END $$;
